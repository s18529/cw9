    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            var res2 = Emps.Where(x => x.Job == "Backend programmer").ToList();
        ...
        {
            var res = Emps.Select(x => x.Salary).Max();
        ...
        {
            var res = Emps.Where(x => x.Salary == Emps.Select(x => x.Salary).Max()).ToList();
            foreach (var element in res)
            {
                Console.WriteLine(element.ToString());
            }
        ...
        {
            var res = Emps.Aggregate((x, next) => x.Salary < next.Salary ? next : x);
            Console.WriteLine(res);
        ...
        {
            var res = Emps.SelectMany(d => Depts, (x, d) => new
            {
                Nazwisko = x.Ename,
                Department = d.Dname
            }).ToList();
